...
> [!important]
> This is different from [[../../content/assets/index]]. The resources from the [[Static]] plugin are located under `quartz/static`, whereas [[../../content/assets/index]] renders all static resources under `content` and is used for images, videos, audio, etc. that are directly referenced by your markdown content.
